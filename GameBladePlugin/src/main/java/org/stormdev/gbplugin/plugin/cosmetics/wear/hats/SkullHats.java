...
public class SkullHats {
	...
	public static class SteveHat extends BlockhatBase{
	...
	public static class SkeletonHat extends BlockhatBase{
	...
	public static class WitherSkeletonHat extends BlockhatBase{
	...
	public static class ZombieHat extends BlockhatBase{
	...
	public static class CreeperHat extends BlockhatBase{
